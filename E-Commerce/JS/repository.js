...
function atualizarPaginaProdutos() {
    ...
    const mostrarAcoes = urlAtual.includes('/html/TodosProdutos.html'); // Exibe os botões apenas na página "TodosProdutos.html"
        ...
        produtoDiv.innerHTML = `
           <div class="poo">
                <div class="Caixateste">
                    <a class="clicar_produtos" href="/html/produto.html?id=${produto.id}">
                      <img class="img_produtos" width="210px" height="210px" src="${produto.foto}" alt="${produto.nome}">
                    </a>
                </div>
                <div class="Detalhes">
